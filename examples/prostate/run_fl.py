...
def main():
    ...
    parser.add_argument("--app", type=str, default="prostate_fedavg", help="App to be deployed")
    ...
    parser.add_argument("--min_clients", type=int, default=4, help="Minimum number of clients.")
    ...
    runner.run(run_number, args.app, restart_all_first=False, shutdown_on_error=True, shutdown_at_end=True,
               timeout=144000, min_clients=args.min_clients)  # will timeout if not completed in 2 hours
