...
class ProstateValidator(SupervisedValidator):
    ...
    def _validation_config(self, fl_ctx: FLContext, train_config_file_path: str):
        ...
        self.valid_metric = DiceMetric(include_background=True, reduction="mean", get_not_nans=False)  # metrics for validation
    ...
    def local_valid(self, valid_loader, abort_signal: Signal):
        ...
        with torch.no_grad():
            ...
            for i, batch_data in enumerate(valid_loader):
                ...
                # Inference
                val_outputs = self.inferer(
                    val_images, self.model
                )
